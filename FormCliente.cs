    ...
    public partial class FormCliente : Form
    {
        ...
        private void btnCadastrar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cliente.Inserir(txtCpf.Text,txtNome.Text, txtCep.Text, txtEndereco.Text, txtBairro.Text, txtCidade.Text, txtCelular.Text,txtEmail.Text, dtpDtNascimento.Value);
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            {
                Cliente cliente = new Cliente();
                cliente.Atualizar(txtCpf.Text, txtNome.Text, txtCep.Text, txtEndereco.Text, txtBairro.Text, txtCidade.Text, txtCelular.Text, txtEmail.Text, dtpDtNascimento.Value);
